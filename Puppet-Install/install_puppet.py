...
if internet_on:
    ...
    the_dmg = downloadChunks("http://downloads.puppetlabs.com/mac/puppet-3.3.1.dmg")
    ##mount the dmg
    ...
    the_command = "/usr/sbin/installer -pkg /Volumes/puppet-3.3.1/puppet-3.3.1.pkg -target /"
    p=subprocess.Popen(the_command,shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    p.wait()
    time.sleep(20)
    print "Ejecting Puppet"
    the_command = "hdiutil eject /Volumes/puppet-3.3.1"
