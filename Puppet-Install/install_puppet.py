...
if internet_on:
    ...
    the_command = "/usr/sbin/installer -pkg /Volumes/facter-2.0.1/facter-2.0.1.pkg -target /"
    p=subprocess.Popen(the_command,shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    p.wait()
    time.sleep(20)
    print "Downloading Puppet"
    the_dmg = downloadChunks("http://downloads.puppetlabs.com/mac/puppet-3.6.1.dmg")
    ##mount the dmg
    ...
    the_command = "/usr/sbin/installer -pkg /Volumes/puppet-3.6.1/puppet-3.6.1.pkg -target /"
    p=subprocess.Popen(the_command,shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    p.wait()
    time.sleep(20)
    print "Ejecting Puppet"
    the_command = "hdiutil eject /Volumes/puppet-3.6.1"
